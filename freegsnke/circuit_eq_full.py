...
class full_circuit_eqs:
    ...
    def __init__(self, evol_metal_curr, evol_plasma_curr):
        ...
        self.full_M_matrix[:len_metal, len_metal:] = np.matmul(
            self.Vm1Rm12, evol_metal_curr.Mey
        )
        self.full_M_matrix[len_metal:, :len_metal] = self.full_M_matrix[
            :len_metal, len_metal:
        ].T
        ...
        self.solver_full = implicit_euler.implicit_euler_solver(
            Mmatrix=self.full_M_matrix,
        ...
        self.Vm1Rm12 = self.Vm1Rm12[
            : evol_metal_curr.n_active_coils, : evol_metal_curr.n_active_coils
        ]
