    ...
    def adjust_psi_plasma(self, ):
        ...
        while (n_up<10) and (opoint_flag==False):
            try:
                ...
                opt, xpt = critical.find_critical(self.R, self.Z, 
        ...
        if xpoint_flag==False:
            ...
            while (xpoint_flag==False) and (n_down < n_down_max):
                ...
                try:
                    ...
                    print('Failed to introduce an xpoint on the domain by scaling down psi_plasma.')
                    break
            ...
            if (xpoint_flag==False) and (n_exp<10):
                ...
                while (xpoint_flag==False) and (n_exp < 10):
                    ...
                    try:
                        ...
                        print('Failed to introduce an xpoint on the domain by exponentiating psi_plasma.')
                        print('Manual initialization advised.')
                        return
                
                # assign from scale-down or exponentiation if successful
                if (xpoint_flag==False):
                    print('Failed to introduce an xpoint on the domain by scaling down or by exponentiating psi_plasma.') 
                    print('Manual initialization advised.')       
                else:
