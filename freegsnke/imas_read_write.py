...
def write_equilibrium_to_ids(
    ...
    time_slice.profiles_1d.psi = 2 * np.pi * np.linspace(eq.psi_axis, eq.psi_bndry, N)
    time_slice.profiles_1d.psi_norm = np.linspace(0, 1, len(time_slice.profiles_1d.psi))
    time_slice.profiles_1d.pressure = eq.pressure(time_slice.profiles_1d.psi_norm)
    time_slice.profiles_1d.f = eq.fpol(time_slice.profiles_1d.psi_norm)
    ...
    time_slice.profiles_2d.resize(3)  # one each for total, plasma, and coil flux
