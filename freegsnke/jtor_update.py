...
def Jtor_fast(Jtor_part1, Jtor_part2, core_mask_limiter, R, Z, psi, psi_bndry, mask_outside_limiter, limiter_mask_out):
...
class Lao85(freegs.jtor.Lao85):
    ...
    def Jtor(self, R, Z, psi, psi_bndry=None, rel_psi_error=0):
